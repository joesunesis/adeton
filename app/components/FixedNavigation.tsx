...
export default function FixedNavigation() {
  ...
  return (
    <nav className="fixed bottom-5 left-1/2 transform -translate-x-1/2 bg-white/90 shadow-lg border border-gray-300 w-full max-w-xs tm:max-w-sm lg:max-w-md rounded-3xl">
